...
$('.rightButtonCarousel').on('click', function(){
    console.log('here')
    $('.rightButtonCarousel').addClass('carouselButtonEffect')
    setTimeout(() => {
        $('.rightButtonCarousel').removeClass('carouselButtonEffect')
    }, 200);
    
    $('.LatestTrending').css('animation','slideRight 1000ms forwards ease-in-out')
    
    setTimeout(() => {
        $('.rightButtonCarousel').css('visibility','hidden')
        $('.leftButtonCarousel').css('visibility','visible')
    }, 700);
})

$('.leftButtonCarousel').on('click', function(){
    $('.leftButtonCarousel').addClass('carouselButtonEffect')
    setTimeout(() => {
        $('.leftButtonCarousel').removeClass('carouselButtonEffect')
    }, 200);
    
    $('.LatestTrending').css('animation','slideLeft 1000ms forwards ease-in-out')

    setTimeout(() => {
        $('.leftButtonCarousel').css('visibility','hidden')
        $('.rightButtonCarousel').css('visibility','visible')
    }, 700);
})